    ...
    ${styles.flexCenter} flex-col relative`}>
      ...
      sm:mb-16 mb-6 relative z-[1]'>
        ...
        <div className="w-full md:mt-0 mt-6">
          <p className={`${styles.paragraph} text-left max-w-[450px]`}>Lorem ipsum dolor sit amet consectetur 
            adipisicing elit. Harum dicta eaque molestiae, 
            facilis voluptates quibusdam?</p>
        </div>
      </div>
      <div className="flex 
      flex-wrap 
